...
public:
    ...
    QWidget *detail_frame;
    QGraphicsView *detailView;
    QLabel *label_RGB;
    QLabel *label_red;
    QLabel *label_blue;
    QLabel *label_green;
    ...
    void setupUi(QMainWindow *mainWindowClass)
    {
        ...
        scrollArea->setGeometry(QRect(0, 0, 781, 851));
        ...
        detail_frame = new QWidget(scrollAreaWidgetContents);
        detail_frame->setObjectName(QStringLiteral("detail_frame"));
        detail_frame->setEnabled(false);
        detail_frame->setGeometry(QRect(520, 490, 131, 71));
        detail_frame->setCursor(QCursor(Qt::BlankCursor));
        detail_frame->setAcceptDrops(false);
        detail_frame->setAutoFillBackground(true);
        detailView = new QGraphicsView(detail_frame);
        detailView->setObjectName(QStringLiteral("detailView"));
        detailView->setGeometry(QRect(10, 10, 51, 51));
        detailView->setBaseSize(QSize(0, 0));
        detailView->viewport()->setProperty("cursor", QVariant(QCursor(Qt::CrossCursor)));
        detailView->setMouseTracking(true);
        detailView->setTabletTracking(true);
        detailView->setVerticalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
        detailView->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
        detailView->setSceneRect(QRectF(0, 0, 0, 0));
        detailView->setAlignment(Qt::AlignCenter);
        detailView->setDragMode(QGraphicsView::NoDrag);
        detailView->setTransformationAnchor(QGraphicsView::AnchorUnderMouse);
        label_RGB = new QLabel(detail_frame);
        label_RGB->setObjectName(QStringLiteral("label_RGB"));
        label_RGB->setGeometry(QRect(70, 10, 47, 13));
        label_red = new QLabel(detail_frame);
        label_red->setObjectName(QStringLiteral("label_red"));
        label_red->setGeometry(QRect(70, 30, 47, 13));
        label_blue = new QLabel(detail_frame);
        label_blue->setObjectName(QStringLiteral("label_blue"));
        label_blue->setGeometry(QRect(70, 50, 47, 13));
        label_green = new QLabel(detail_frame);
        label_green->setObjectName(QStringLiteral("label_green"));
        label_green->setGeometry(QRect(70, 40, 47, 13));
    ...
    void retranslateUi(QMainWindow *mainWindowClass)
    {
        ...
        label_RGB->setText(QApplication::translate("mainWindowClass", "RGB", nullptr));
        ...
        block_size->setText(QApplication::translate("mainWindowClass", "16", nullptr));
